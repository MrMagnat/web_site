...
const NAV = [
  ...
  { label: "Коллекции", href: "/admin/collections", icon: Layers },
  { label: "Заказы", href: "/admin/orders", icon: ShoppingBag },
  { label: "Покупатели", href: "/admin/customers", icon: Users },
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: "#191E1B" }}
      >
        <span
          className="font-prata text-white text-base"
